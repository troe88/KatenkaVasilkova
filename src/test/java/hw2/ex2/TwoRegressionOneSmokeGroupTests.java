...
public class TwoRegressionOneSmokeGroupTests {

    @Test(groups = "Regression")
    public void simpleTestWithHardAsserts31() {
    ...
    @Test(groups = "Regression")
    public void simpleTestWithHardAsserts32() {
    ...
    @Test(groups = "Smoke")
    public void simpleTestWithHardAsserts33() {
